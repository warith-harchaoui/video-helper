...
- **Packaging**: `pyproject.toml`'s `description` (PyPI `summary` metadata)
  exceeded PyPI's 512-character limit, which rejected the upload outright.
  Trimmed to the same content, more concisely worded.
