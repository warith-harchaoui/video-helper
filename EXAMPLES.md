...
`frame_interval` (seconds between frames). It uses VidGear under the
hood with optional video stabilization.
...
for frame in vh.extract_frames(
    ...
    # frame: numpy.ndarray of shape (H, W, 3), uint8 in [0, 255]
    pass
```
